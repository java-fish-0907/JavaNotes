...
private static Wrapper makeWrapper(Class<?> c) {
    ...
    for (Method m : methods) {
        ...
        // if ("sayHello".equals(2)        //     &&3.length == 2
        //     && 3[0].getName().equals("java.lang.Integer")        //     &&3[1].getName().equals("java.lang.String")) {
        //
...
![img_1.png](https://gitee.com/hezhiyuan007/java-study/raw/master/images/dubboSC/dd885c36-4651-4cec-9c8e-fd33610b6c7d.png)
...
本篇文章详细分析了 Dubbo 服务导出过程，包括配置检测，URL 组装，Invoker 创建过程、导出服务以及注册服务等等。篇幅比较大，需要大家耐心阅读。对于这篇文章，我建议大家当成一个工具书使用。需要的时候跳到指定章节看一下，通读可能会有点累。由于文章篇幅比较大，因此可能会隐藏一些我没意识到的错误。若大家在阅读的过程中发现了错误，还请指出。如果能够不吝赐教，那就更好了，先在这里说声谢谢。
