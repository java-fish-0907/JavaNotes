...
![img_1.png](https://gitee.com/hezhiyuan007/java-study/raw/master/images/dubboSC/f0690ebe-04e4-4396-ab60-8d2119a911d0.png)

关于一致性 hash 算法，我这里只做扫盲。具体的细节不讨论，大家请自行补充相关的背景知识。下面来看看一致性 hash 在 Dubbo 中的应用。我们把上图的缓存节点替换成 Dubbo 的服务提供者，于是得到了下图：

![img_2.png](https://gitee.com/hezhiyuan007/java-study/raw/master/images/dubboSC/d762d17d-4b74-4ff2-9003-93e1147f3d5d.png)
...
![img_3.png](https://gitee.com/hezhiyuan007/java-study/raw/master/images/dubboSC/0bb2c073-39cf-4e7b-b219-a19fa38339f5.png)
...
请求编号 currentWeight 数组 选择结果 减去权重总和后的 currentWeight 数组 1 [5, 1, 1] A [-2, 1, 1] 2 [3, 2, 2] A [-4, 2, 2] 3 [1, 3, 3] B [1, -4, 3] 4 [6, -3, 4] A [-1, -3, 4] 5 [4, -2, 5] C [4, -2, -2] 6 [9, -1, -1] A [2, -1, -1] 7 [7, 0, 0] A [0, 0, 0]
