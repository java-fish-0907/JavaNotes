...
在学 Java SE 的时候我们学习了一个标准类 `java.net.URL`，该类在 Java SE 中的定位为统一资源定位器（`Uniform` `Resource` `Locator`），但是我们知道它的实现基本只限于网络形式发布的资源的查找和定位。

然而，实际上资源的定义比较广泛，除了网络形式的资源，还有以二进制形式存在的、以文件形式存在的、以字节流形式存在的等等。而且它可以存在于任何场所，比如网络、文件系统、应用程序中。所以 `java.net.URL` 的局限性迫使 Spring 必须实现自己的资源加载策略，该资源加载策略需要满足如下要求：
...
![spring-201805091003](https://gitee.com/hezhiyuan007/java-study/raw/master/images/SpringSourceCode/15cf6a09-a0ca-4619-a930-81089616aba1.png)
...
![spring-201805091004](https://gitee.com/hezhiyuan007/java-study/raw/master/images/SpringSourceCode/7c7541d8-8ee2-45c6-aa73-f4a6710f8a11.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/SpringSourceCode/86fb9488-5061-4755-9765-a100dd91dd1d.png)
