![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/2ca410cf-e0db-4a92-b1a6-79fba5a4eca7.png)
...
![Linux TCP 参数](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/c8f5481d-bb1d-49ef-87e2-0817273b5ca2.png)

如何正确有效的使用这些参数，来提高 TCP 性能是一个不那么简单事情。我们需要针对 TCP 每个阶段的问题来对症下药，而不是病急乱投医。

接下来，将以三个角度来阐述提升 TCP 的策略，分别是：

![本节提纲](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/6b7aa9dd-3def-42f9-bc94-002c0a844d9e.png)

## 正文

TCP 是面向连接的、可靠的、双向传输的传输层通信协议，所以在传输数据之前需要经过三次握手才能建立连接。

![三次握手与数据传输](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/a2ae1583-e93b-487f-b34f-d78df0ad8552.png)
...
![TCP 三次握手的状态变迁](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/d487764e-bd39-41a1-aa2c-28995704a86d.png)
...
![TCP 头部](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/bb426f87-182e-4b74-ab77-3256e0e05124.png)
SYN_SENT 状态的优化
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/ad2e6d30-324a-46ed-bd9e-d592033d8020.png)
...
![SYN 超时重传](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/d493732b-099d-48dd-97ab-9a1bcf122916.png)
...
![半连接队列与全连接队列](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/90cb6cd0-1152-47e8-9885-9838913a0bf4.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/ea0b9d7e-99bc-4eae-8702-b5c41de848d7.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/ee185cec-fd42-44ff-8652-1e85d2b5500a.png)

增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/667c999f-3ac8-4fd5-be53-9e3aec7d5534.png)
...
![开启 syncookies 功能](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/8f822fad-ac1d-4843-acc0-1356a5d69f9c.png)

syncookies 参数主要有以下三个值：

那么在应对 SYN 攻击时，只需要设置为 1 即可：

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/612cb28b-aefc-45a9-9026-a3d294e413a3.png)
SYN_RCV 状态的优化
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/84f651da-e7d7-4967-8d04-0dd68a62394c.png)
...
![ accept 队列溢出](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/8450a7c3-59ea-4c47-80fe-785c4a1cfa79.png)
accept 队列已满，只能丢弃连接吗？

丢弃连接只是 Linux 的默认行为，我们还可以选择向客户端发送 RST 复位报文，告诉客户端连接已经建立失败。打开这一功能需要将 tcp_abort_on_overflow 参数设置为 1。

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/5ae660f2-f4f8-4b79-8090-871e5986c6da.png)
...
![tcp_abort_on_overflow 为 0 可以应对突发流量](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/0d81414d-a720-465c-a67a-268bfcb40b7c.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/323a201f-30cb-4209-b103-be4ee98b818b.png)

如何查看由于 accept 连接队列已满，而被丢弃的连接？

当超过了 accept 连接队列，服务端则会丢掉后续进来的 TCP 连接，丢掉的 TCP 连接的个数会被统计起来，我们可以使用 netstat -s 命令来查看：

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/d08ea695-0afc-4598-99ba-69330f7f414a.png)
...
![常规 HTTP 请求](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/eca5e4ed-80cd-42cc-b3de-21c9d7c50ef5.png)

在 Linux 3.7 内核版本之后，提供了 TCP Fast Open 功能，这个功能可以减少 TCP 连接建立的时延。
接下来说说，TCP Fast Open 功能的工作方式。

![开启 TCP Fast Open 功能](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/d5feba6a-c27f-4ed6-8534-ebc376bbd010.png)
...
![TCP option 字段 - TFO](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/f8051cc0-1670-4120-892f-273cf24bc003.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/b2beeab9-dcd5-42d8-9fac-e75d081a5954.png)
...
![三次握手优化策略](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/4c4c957c-15a8-4aa5-a693-fd1fff634de9.png)
客户端的优化
...
![客户端主动关闭](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/12af038b-0417-4f9e-9d24-2e38acf40525.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/ec53943c-ee4a-41b2-80ba-c8ff19373093.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/f59dad51-ddb7-44df-b4a6-7186f6917535.png)

你可能会好奇，这 0 表示几次？**实际上当为 0 时，特指 8 次**，从下面的内核源码可知：

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/fab7cfe3-2507-42af-bcdc-e61f79940081.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/8c506742-0497-465a-8263-cb15bd778007.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/f264e823-f155-4acf-832e-0700503d25ee.png)
...
![接收到历史数据的异常](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/496be569-eb03-4298-b0f0-98184cb86a52.png)
...
![没有确保正常断开的异常](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/18b55de3-5935-4cee-af03-a71d5db7ffda.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/5fe2f692-0517-454b-b8a6-2afbcb8f7363.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/7f2c7772-6b71-4028-bac9-bae088521efd.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/1b4ddea1-9434-47ac-84ab-186af310fcc0.png)

由于引入了时间戳，它能带来了些好处：

时间戳是在 TCP 的选项字段里定义的，开启了时间戳功能，在 TCP 报文传输的时候会带上发送报文的时间戳。

![TCP option 字段 - 时间戳](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/30cb570e-870e-47fb-98f9-6163f0d4eaea.png)

我们来看看开启了 tcp_tw_reuse 功能，如果四次挥手中的最后一次 ACK 在网络中丢失了，会发生什么？

![四次挥手中的最后一次 ACK 在网络中丢失](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/43fec3f4-1cf6-48dd-9722-a5f291b33836.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/896661c8-33f5-4b2d-bea2-d2d5ed618551.png)

另外，我们可以在程序中设置 socket 选项，来设置调用 close 关闭连接行为。

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/a24db36b-f19e-4242-8a93-947acccdec3b.png)
...
![同时关闭](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/7721a105-50dc-4997-a78c-168a3d7d3d0e.png)
...
![四次挥手的优化策略](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/b9bd053f-1ccc-461b-b3d1-5af1930bdfe8.png)
主动方的优化
...
![按数据包进行确认应答](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/3fb34227-207e-4c93-ad4f-b0a57b51e50a.png)

所以，这样的传输方式有一个缺点：数据包的**往返时间越长，通信的效率就越低**。

**要解决这一问题不难，并行批量发送报文，再批量确认报文即可。**

![并行处理](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/4f21a1b0-45b5-45f6-997c-5a417abebd96.png)
...
![TCP 头部](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/487d36ff-6904-4f68-93a9-aee7c65ed7a5.png)
...
![TCP option 选项 - 窗口扩展](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/90affad8-72ba-49b4-a4dc-60842609e8cc.png)

Linux 中打开这一功能，需要把 tcp_window_scaling 配置设为 1（默认打开）：

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/d4a7643d-c5af-4fb5-b638-1cafde6a9c75.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/afc26324-7055-47ad-a896-edb8800e5e9f.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/de1e95fc-6339-4527-8e77-7f4d8c8a0c8a.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/7d7eafb3-053a-43cb-aeca-0d68183e52e2.png)
...
![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/70c05155-59df-48b7-8d30-88356b6b4a20.png)
调节 TCP 内存范围

接收缓冲区调节时，怎么知道当前内存是否紧张或充分呢？这是通过 tcp_mem 配置完成的：

![](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/0822cb2f-8f38-4a9f-aa9d-ce55abaa8b83.png)
...
![数据传输的优化策略](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/843b9871-4d19-4e08-915c-9bd282ae09b2.png)
...
![亮白](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/a0e34459-0bfa-4b07-bb0b-89d4b856ca70.png)

![暗黑版本](https://gitee.com/hezhiyuan007/java-study/raw/master/images/Network/702c1c52-780b-48ca-baa6-1248274852fa.png)
