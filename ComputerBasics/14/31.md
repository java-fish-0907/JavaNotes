...
public class Solution {
    ...
    private void dfs(TreeNode node, List path, List res) {
        if (node == null) {
            return;
        }
        path.add("" + node.val);
    ...
    public static void main(String[] args) {
        ...
        List binaryTreePaths = solution.binaryTreePaths(node1);
...
说明：下面第 1 个选项卡的 Python 代码是 [@何去何从gw](https://www.liwei.party/u/he-qu-he-cong-gw) 用户在评论区中提供的，并且指出了“隐式回溯”的概念，在此表示感谢。
...
public class Solution2 {
    ...
    private void dfs(TreeNode node, String pre, List res) {
